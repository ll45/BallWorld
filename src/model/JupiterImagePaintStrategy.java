...
/**
 * This is the class that paints an image of Jupiter.
 * @author sn32, ll45
 */
public class JupiterImagePaintStrategy extends ImagePaintStrategy {
	/**
	 * This is the constructor that calls its super constructor on the proper image.
	 */
	public JupiterImagePaintStrategy() {
		super("images/Jupiter.gif", 1.0);
	}
}
