...
public class BallWorldModel {
	...
	public void update(Graphics g) {
		dispatcher.notifyAll((IBallCmd) (ball, disp)->{
...
//        dispatcher.notifyAll(g);
	 ...
	 * @param paintStrat The IPaintStrategy that determines how to paint the ball
	 */
	...
	/**
	 * This function returns an IStrategyFac to allow the Paint Strategies to be made later on.
	...
	/**
	 * This function loads an instance of an IPaintStrategy, given a classname.
	...
	/**
	 * This function "fixes" the type passed in to create an IPaintStrategy.
	 * @param classname The type of paint strategy to create.
	 * @return The fixed paint strategy information as a string.
	 */
	public String fixPaintName(String classname) {
		return "model." + classname + "PaintStrategy";
	}
