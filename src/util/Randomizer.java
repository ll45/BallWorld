/**
 * This is the util package with helpful utilities.
 */
package util;
...
public class Randomizer implements IRandomizer {
	/**
	 * This is a static variable which is an instance of a Randomizer.
	 */
	public static Randomizer Singleton = new Randomizer();

	/**
	 * This is the constructor for a Randomizer.
	 */
	private Randomizer() {
	}

	/**
	 * Generates a random location point subject to the constraint that 0 less than x less than rect.width
	...
	/**
	 * Generates a random location point subject to the constraint that 0 less than x less than dim.width
	...
	/**
	 * Returns a random velocity (as a Point) subject to the constraint that the absolute value
	...
	/**
	 * Returns a random square Dimension, whose width is maxDim.width/2 less than width less than maxDim.width
